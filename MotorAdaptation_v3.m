function [Test, Train, After] = MotorAdaptation_v3(n_trials,input_device,test_subject,folder_path)
%% 
%[Test, Train, After] = MotorAdaptation_v3(n_trials,input_device,test_subject,folder_path)
...
str = [folder_path filesep 'v3_' test_subject, '_', num2str(i) '.mat'];
if exist(str, 'file') == 0
    trr = true;
else
    trr = false;
