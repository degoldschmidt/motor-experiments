function [Test, Train, After] = MotorAdaptation_v2(n_trials,input_device,test_subject,folder_path)
%% 
%[Test, Train, After] = MotorAdaptation_v2(n_trials,input_device,test_subject,folder_path)
% Example: folder_path = 'C:\Users\Rodrigo\Documents\INDP2015\Motor Week\Data';
% n_trials = [10 10 10]; - trials for each phase of experiment
...
while ~exitDemo
    ...
    if menu == 0
        ...
        while ~KbCheck
            ...
            line7 = '\n\n\n >> The movement should be ballistic, performance includes speed and accuracy';
    ...
    elseif menu == 2
        ...
        while ~KbCheck
            ...
            line4 = '\n\n\n >> In addition, a rotation of 45 degrees was applied to the cursor.';
            line5 = '\n\n\n >> Hint: In order to hit the target, you should aim two dots counter-clockwise from the target position.';
            line6 = '\n\n\n >> Remember: your target position is still the red dot!';
            line7 = '\n\n\n Press any key to continue';
            Screen('TextSize', window, 25 );
            DrawFormattedText(window, [line1 line2 line4 line5 line6 line7],...
                'center', screenYpixels * 0.25, black);
            Screen('Flip', window);
